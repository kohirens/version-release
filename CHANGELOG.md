...
- GitHub Action Checkout To v6
- The Default Git Cliff Configuration
...
- Removed GitHub Actions Permission Requirement

## [5.1.7]

### Removed

- GitHub Action Requirement

## [5.1.6]

### Changed

- Remove GitHub Actions Required Parameter

## [5.1.5]

### Fixed

- GitHub Actions Selecting a Workflow
...
- Unexpected TypeError in selector workflow
...
- Increment Git-Cliff Version

### Fixed

- GitHub Action
- Configure GitHub Server and API
...
- Obsolete Setting Git User and Email

## [5.0.5]

### Documentation

- Updated README Brochure

### Fixed

- Add Additional Files To Changelog Commit

### Regular Maintenance

- Upgrade CI Configuration AVR

### Removed

- Remove file Parameter from CircleCI Orb

## [5.0.4]

### Changed

- Added GitHub Seletor Workflow Template
- Add Additional Commit Files
...
- Refactor Adding Files to Changelog Commit
- Refactor Adding Files to Changelog Commit

### Regular Maintenance

- Fix CI
- Cleanup Yaml Long Lines
...
- Upgraded CirclCI Release Automation
- CI Cleanup
...
- Publish Changelog During Auto Release

### Regular Maintenance

- Update README.md
- Upgraded CI Auto Version Release Version
...
- Secure Auto Version Release Container

## [4.4.0] - 2024-06-28

### Added

- Enhance Output For gh-has-release Command/Job

### Testing

- Gh-has-release Command

## [4.3.0] - 2024-06-28

### Added

- Command To Verify GitHub Release
- Job To Check GitHub Has A Release

### Changed

- Save GitHub Has Release Reponse To A File

### Testing

- GitHub Has Release Script

## [4.2.4] - 2024-06-15

### Changed

- How Environment Variable Are Sourced

## [4.2.3] - 2024-06-15

### Fixed

- Match Changelog Tag With Release Tag When Set Manually

## [4.2.2] - 2024-06-15

### Fixed

- Image Publish When Tag Set By File, Environment, or Command

### Regular Maintenance

- Content Change To Clarify What the Orb Does

## [4.2.1] - 2024-06-15

### Fixed

- Added GitHub SSH Keys To Known Host

## [4.2.0] - 2024-06-15

### Added

- Pull SSH Keys When Interacting With GitHub

### Changed

- Error When No Unreleased Changes To Tag

### Fixed

- Output When Setting Version Info From A File
