...
func TestWorkflowSelector_PublishChangelog(runner *testing.T) {
	...
	cases := []struct {
		...
		{"circleci", []string{"-wd", repo, "workflow-selector", "CHANGELOG.md", "e9daa3786634ae4ae1346c65dd46247c08eb8416"}, 0},
		{"github", []string{"-wd", repo, "workflow-selector", "CHANGELOG.md", "e9daa3786634ae4ae1346c65dd46247c08eb8416"}, 0},
	}
...
func TestWorkflowSelector_TagRelease(runner *testing.T) {
	...
	cases := []struct {
		...
		{"circleci", argsFixture, 0},
		{"github", argsFixture, 0},
	}
